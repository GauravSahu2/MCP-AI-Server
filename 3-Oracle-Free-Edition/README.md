# 🛡️ MCP+AI Platform (Oracle Always-Free Tier)
...
A property-tested, highly resilient Model Control Plane and AI routing platform originally designed for large enterprise inference. This portfolio variant explicitly tackles the **Oracle Cloud (OCI)** ecosystem to demonstrate deep-dive infrastructure control, scaling mechanisms, and fault-tolerant architecture mapping.
**Core Business Value Add:** 4 ARM cores and 24GB RAM running zero-cost K3s.
...
├── terraform/                  # Oracle Cloud (OCI) IaC declarative state config
└── README.md                   # This file
```
